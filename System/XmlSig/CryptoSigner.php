...
namespace DGII\XmlSig;

use EllipticCurve\Ecdsa;
use EllipticCurve\PrivateKey;
use DGII\XmlSig\Exception\CertificateException;
use DGII\XmlSig\Exception\XmlSignerException;
...
final class CryptoSigner implements CryptoSignerInterface
{
    ...
    {
        // Calculate and encode digest value
        $digestValue = openssl_digest($data, $this->algorithm->getDigestAlgorithmName(), false);
